...
- [x] Provide the starting X List: [House account List](https://x.com/i/lists/1841177179872243858).
...
No other upfront homework. We will surface further questions only when they affect a concrete implementation decision that cannot be resolved from examples or existing evidence.
